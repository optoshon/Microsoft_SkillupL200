...
# Test embedding
test_text = "How many annual learning hours are required for employees in Grade G5 per financial year?"
...
query = "How many annual learning hours are required for employees in Grade G5 per financial year?"
print(f"🔍 Query: {query}")
